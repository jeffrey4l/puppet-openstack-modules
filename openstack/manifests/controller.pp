...
class openstack::controller (
  ...
  Class['openstack::db::mysql'] -> Class['cinder::base']
  Class['openstack::db::mysql'] -> Class['cinder::api']
  Class['openstack::db::mysql'] -> Class['cinder::scheduler']
  Class['openstack::db::mysql'] -> Class['openstack::horizon']
  ...
  class { 'openstack::glance':
    ...
    glance_user_password => $glance_user_password,
    bind_host            => $bind_address,
    registry_host        => $internal_address,
  ...
  if ($cinder) {
    ...
    class { 'cinder::api':
      ...
      keystone_auth_host => $public_address,
      bind_host          => $bind_address,
    }
